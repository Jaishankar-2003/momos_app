...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  ...
  Future<void> _markDelivered(OrderModel o) async {
    ...
    final result = await DBHelper.instance.markOrderDelivered(o.id!);
    if (result > 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Order marked as delivered')),
      );
      await _load(); // 🔄 reload orders
    }
  }
                  ...
                  final confirm = await showDialog<bool>(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            FeedbackHelper.orderDelivered(); // 🚚 delivery sound
      ...
      body: RefreshIndicator(
        ...
        child: _orders.isEmpty
          ...
          itemBuilder: (context, i) {
            ...
            return Card(
              color: o.isDelivered ? Colors.green.shade100 : null, // 🎉 GREEN
              margin: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
              child: ListTile(
                trailing: o.isDelivered
